...
This project is indexed by GitNexus as **dealerships-compliance** (1699 symbols, 4509 relationships, 136 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
