...
This project is indexed by GitNexus as **dealerships-compliance** (1672 symbols, 4459 relationships, 134 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
